This is a reference library — read the file you need, don't preload everything.

| Topic | File |
|---|---|
| Stack overview + Quick Start | README.md |
| Repo rule (read-only reference) | CLAUDE.md |
| Seven-rung architecture framework | docs/SYSTEMS_THINKING_FRAMEWORK.md |
| Master wiring guide | docs/INTEGRATION_GUIDE.md |
...
| One-page stack overview | setup/STACK.md |
